...
<main class="font-jost hyphens-manual flex-grow pb-12 mt-5">
  <div class="flex items-center justify-center">
    <div class="bg-neutral-900 font-semibold text-center rounded-3xl border border-neutral-800 shadow-lg p-10 max-w-xs">
      ...
      <h1 class="text-lg text-gray-200"> Martin Holmgren</h1>
      <h3 class="text-sm text-gray-400 "> {$_('martin-work')}</h3>
      <p class="text-xs text-gray-400 mt-4">{$_('mainpage-quote1')} </p>
      <p class="text-xs text-gray-400 mt-4">{$_('mainpage-quote2')} </p>
